...
<body>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <!--usuarios-->
<!--
        div class ="sidebar-nav" (principal)
        ul id="dashboard-menu"      (principal)
-->
        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row form-wrapper">
                ...
                <div id="miPagina" class="col-md-7 column"><!--segunda columna de centrado-->
					<h2 align="center">Habilitar Investigador</h2></br></br>

                    <form method="POST" action="../admin/control/cliente_habilitar.php">
    
                        <div class="field-box">
                            <label>Cedula:</label>
                            <div class="col-md-7">
                                <input name="ci" id="ci" class="form-control" required type="number" min="00000000" max="99999999" autofocus>
                            </div>        
