        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row form-wrapper">
                ...
                <div id="miPagina" class="col-md-7 column"><!--segunda columna-->
					<h2 align="center">Registrar Salas</h2></br></br>

                    <form method="POST" action="../admin/control/salas_reg.php" autocomplete="off">
    
                        <div class="field-box">
                            <label>Direccion:</label>
                            <div class="col-md-7">
                                <input name="direcc_salas" id="direcc_salas" class="form-control" onblur="javascript:this.value=this.value.toUpperCase();" required autofocus type="text" placeholder="Ingrese Direccion de Comunidad">
                            </div>                            
                        </div>
                        <div class="field-box">
                            <label>Istitucion:</label>
                            <div class="col-md-7">
                                <input name="codigo_salas" id="codigo_salas" class="form-control" onblur="javascript:this.value=this.value.toUpperCase();" required type="text" placeholder="Ingrese Direccion Institucion">
                            </div>                        
                        <div class="action">
