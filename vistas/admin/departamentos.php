    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <a class="dropdown-toggle" href="#"><!--separaci_useron-->
        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row form-wrapper">
                ...
                <div id="miPagina" class="col-md-7 column"><!--segunda columna-->
					<h2 align="center">Gestionar Departamento</h2></br></br>

        <!--FORMULARIO--> 

                    <form method="POST" action="../../control/departamento_reg.php" autocomplete="off">
    
                        <div class="field-box">
                            <label>Departamento:</label>
                            <div class="col-md-7">
                                <input name="nombre_departamento" id="nombre_departamento" class="form-control" placeholder="Nombre Departamento" required autofocus type="text" onblur="javascript:this.value=this.value.toUpperCase();">
                            </div>                            
                        </div>
                        <div class="action">
