        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row form-wrapper">
                ...
                <div id="miPagina" class="col-md-7 column"><!--segunda columna-->
					<h2 align="center">Agregar Equipo</h2></br></br>

                    <form method="POST" action="../admin/control/equipo_reg.php" autocomplete="off">
    
                        <div class="field-box">
                            <label>Codigo Equipo:</label>
                            <div class="col-md-7">
                                <input name="codigo_equipo" id="codigo_equipo" class="form-control" required autofocus type="text" placeholder="pc-1" onblur="javascript:this.value=this.value.toUpperCase();">
                            </div>
                        </div>
                         <div class="field-box">
                            <label>Sistema Operativo:</label>
                            <div class="col-md-7">
                                <input name="sistema_operativo" id="sistema_operativo" class="form-control" required autofocus type="text" placeholder="Debian 7" onblur="javascript:this.value=this.value.toUpperCase();">
                            </div>                            
                        </div>
                         <div class="field-box">
                            <label>Tipo de Sistema:</label>
                            <div class="col-md-7">
                                <input name="tipo_sistema" id="tipo_sistema" class="form-control" required autofocus type="text" placeholder="64 bit"
                         ...
                         <div class="field-box">
                            ...
                            <div class="col-md-7">
                                <input name="procesador" id="procesador" class="form-control" required autofocus type="text" placeholder="intel core I3"
                                onblur="javascript:this.value=this.value.toUpperCase();">
                            </div>                            
                        </div>
                         <div class="field-box">
                            <label>Memoria:</label>
                            <div class="col-md-7">
                                <input name="memoria" id="memoria" class="form-control" required autofocus type="text" placeholder="ddr2 2gb 1333mhz"
                                onblur="javascript:this.value=this.value.toUpperCase();">
                            </div>                            
                        </div>
                         <div class="field-box">
                            ...
                            <div class="col-md-7">
                                <input name="dd" id="dd" class="form-control" required autofocus type="text" placeholder="Maxtor 500 gb"
                                onblur="javascript:this.value=this.value.toUpperCase();">
                            </div>                            
                        </div>
...
<!--ojo-->    <script src="../vistas/js/jquery-latest.js"></script>
    ...
    <script src="../../vistas/js/functions-popover.js"></script> <!-- comentarios de los componentes -->
