...
$localizar=pg_num_rows($verifica);
	if ($localizar!=0) {
		...
		$INSERTAR = pg_query($conectando->conectar(), "INSERT INTO acadmics_prof (id_prof, pre_acadmics, post_acadmics, prom_acadmics,  univ_acadmics_pre, pre_acadmics_tit, post_acadmics_tit, univ_acadmics_post)
		VALUES ((SELECT id_prof FROM dp_prof WHERE ci_prof = '$ci_prof'),'$pre_acadmics', '$post_acadmics', '$prom_acadmics', '$univ_acadmics_pre', '$pre_acadmics_tit', '$post_acadmics_tit', '$univ_acadmics_post')");	
		if (!$INSERTAR) { 
