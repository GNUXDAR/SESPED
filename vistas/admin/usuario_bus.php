        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row form-wrapper">
                ...
                <div id="miPagina" class="col-md-7 column"><!--segunda columna de centrado-->
					<h2 align="center">Consultar Usuario</h2></br></br>

                    <form method="POST" action="../../vistas/admin/usuario_mostrar.php">
    
                        <div class="field-box">
                            <label>Cedula:</label>
                            <div class="col-md-7">
                                <input name="ci_personal" id="ci_personal" class="form-control" required type="number" min="00000000" max="99999999" placeholder="12345678" autofocus>
                            </div>        
                        <div class="action">
