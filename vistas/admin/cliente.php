        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row form-wrapper">
                ...
                <div id="miPagina" class="col-md-7 column"><!--segunda columna de centrado-->
					<h2 align="center">Registrar Investigador</h2></br></br>
                      ...
                      <div class="field-box">
                        ...
                        <!--invoca el form cliente_visitante.php o cliente_investigador.php-->
                        <!--cliente_investigador.php es interno -->
                        <!--invoca el form cliente_visitante.php  es externo-->
                </div> <!--mi pagina-->
