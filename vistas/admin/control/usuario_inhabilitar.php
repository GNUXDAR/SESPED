...
$mod=pg_query($conectando->conectar(),  "UPDATE personal set status = '3' WHERE ci_personal = '$ci'");
$mod2=pg_query($conectando->conectar(),  "UPDATE usuarios set status_user = '3' WHERE ci_user = '$ci'");
    ...
    if ($mod && mod2) { 
        ...
        print ("<script>alert('El usuario fue inhabilitada exitosamente');</script>");
        print('<meta http-equiv="refresh" content="0; URL=../../admin/usuario_inh.php">');
       
        }

    else { 
        print ("<script>alert('El usuario no pudo ser inhabilitada');</script>");
        print('<meta http-equiv="refresh" content="0; URL=../../admin/usuario_inh.php">');
