...
$mod=pg_query($conectando->conectar(),  "UPDATE personas set status = '2' WHERE ci_persona = '$ci'");
    ...
    if (!$mod) { 
        ...
        print ("<script>alert('La persona no pudo ser inhabilitada');</script>");
        print('<meta http-equiv="refresh" content="0; URL=../../admin/cliente_inh.php">');
        }

    else { 
        print ("<script>alert('La persona fue inhabilitada exitosamente');</script>");
        print('<meta http-equiv="refresh" content="0; URL=../../admin/cliente_inh.php">');
        }
