	...
	$("form").on('submit', function(e) {
		...
		$.ajax({
			  ...
			  data: { nombre: nombre, ape_paterno: ape_paterno, ape_materno: ape_materno,
			  		   ci: ci, edad: edad, direccion: direccion, carrera: carrera },
			  success: function(msg){
			  	if(msg == "correcto"){
			  		$("#mensaje").html("<div class='alert alert-success'><i class='icon-ok-sign'></i> Investigador registrado con Exito</div>");
			  		listarClientes();
			  	}
			  }		  
		}).done(function() {
...
//tabla derecha con datos registrados
