...
$buscarPersona="SELECT * FROM dp_prof INNER JOIN acadmics_prof ON dp_prof.id_prof = acadmics_prof.id_prof  WHERE ci_prof='$ci_prof'";
        ...
        $ATRIBUTO=pg_fetch_array($verificaPersona);?>
            ...
            <h3>Profesional</h3>
                ...
                <input name="ci_prof" id="ci_prof" value ="'.$ATRIBUTO['ci_prof'].'" class="form-control" required type="hidden">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3">Titulo de Pregrado</label>
                      <div class="col-sm-6">
                        <label class="col-sm-6"><?php echo$ATRIBUTO['pre_acadmics_tit']. " En ".$ATRIBUTO['pre_acadmics']; ?></label>
                      </div>
                    </div>
                    </br></br><!-- saltos de lineas en bootstrap -->
                    <div class="form-group">
                        <label class="col-sm-3">Titulo de Postgrado</label>
                      <div class="col-sm-6">
                        <label class="col-sm-6"><?php echo$ATRIBUTO['post_acadmics_tit']. " En ".$ATRIBUTO['post_acadmics']; ?></label>
                      </div>
                    </div>
                    </br></br><!-- saltos de lineas en bootstrap -->
                    <div class="form-group">
