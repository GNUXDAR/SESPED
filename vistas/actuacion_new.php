...
include_once('script.php');
        ...
        <div class="form-group">
        	<label class="col-sm-3">Formación de Talentos</label>
        	<div class="col-sm-6">
    ...
    <div class="form-group">
    	<label class="col-sm-3">Participación en Eventos</label>
    	<div class="col-sm-6">
...
<div class="form-group">
	<label class="col-sm-3">Trabajo de Investigación</label>
	<div class="col-sm-6">
