        ...
        <form id="miFormulario" action="control/login.php" method="POST" autocomplete="off">
            ...
            <div class="box"> 
                <div class="content-wrap">
                    ...
                    <input name="login_usr" id="login_usr" class="form-control" type="text" placeholder="Correo" required autofocus>
            ...
            <br><br>
                <a href="vistas/page_register.php" class="txt-default">No tiene cuenta?</a>
    </div>
        </form>
    </div>
